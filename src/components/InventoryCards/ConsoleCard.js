...
export default function ConsoleCard({ consoleB, notify }) {
    ...
    function handleDelete() {
        ...
        .then(() => notify({ action: 'delete', consoleB: consoleB }))
    ...
    return (
        ...
        <td>
            ...
            <button id="editButton" className="btn btn-secondary" type="button" onClick={() => notify({ action: "edit-form", consoleB: consoleB})}>Edit</button>
        </td>
        </tr>
    )
}